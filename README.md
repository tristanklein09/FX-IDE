...
This project relies on the BellSoft Liberica JDK (version 25.0.2), as it includes javafx and offers good support for computers that do not necessarily use an x86 CPU architecture. I highly recommend that you use this when running the program, although I have not tested alternate methods of using javafx. 
